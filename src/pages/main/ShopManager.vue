...
export default {
  ...
  methods: {
    ...
    shopimgsUploadSuccess(res) {
      if (res.code == 0) this.pics.push(res.imgUrl); //把上传的图片加到pics中
    },
    ...
    //修改店铺数据
    clickSave() {
      // this.xxxdata.date = JSON.stringify(this.xxxdata.date)
      // this.xxxdata.supports
      // this.xxxdata.pics = JSON.stringify(this.)

      // let params = JSON.parse(SON.stringify(this.xxxdata))
